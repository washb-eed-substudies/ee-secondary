...
washb_bd_immun<- read.csv("~/Dropbox/WBB-EE-analysis/Data/Cleaned/Audrie/washb-bangladesh-plasma-lab-t2-t3-ipcw.csv", stringsAsFactors = TRUE)

#load
dfull<- read.csv("~/Dropbox/WBB-EE-analysis/Data/Cleaned/Audrie/washb-bangladesh-anthro-diar-ee-med-enrol-tracking-immun-ipcw2.csv", stringsAsFactors = TRUE)

#load blinded treatment data
washb_bd_tr <- read.csv("~/Dropbox/WBB-EE-analysis/Data/Untouched/washb-bangladesh-tr.csv", stringsAsFactors = TRUE)
...
save(igf_t2_adj_ipcw_L, igf_t3_adj_ipcw_L, crp_t2_adj_ipcw_L, agp_t2_adj_ipcw_L, gmc_t2_adj_ipcw_L, ifn_t2_adj_ipcw_L, il10_t2_adj_ipcw_L, il12_t2_adj_ipcw_L, il13_t2_adj_ipcw_L, il17_t2_adj_ipcw_L, il1_t2_adj_ipcw_L, il2_t2_adj_ipcw_L, il21_t2_adj_ipcw_L, il4_t2_adj_ipcw_L, il5_t2_adj_ipcw_L, il6_t2_adj_ipcw_L, tnf_t2_adj_ipcw_L, gmc_t3_adj_ipcw_L, ifn_t3_adj_ipcw_L, il10_t3_adj_ipcw_L, il12_t3_adj_ipcw_L, il13_t3_adj_ipcw_L, il17_t3_adj_ipcw_L, il1_t3_adj_ipcw_L, il2_t3_adj_ipcw_L, il21_t3_adj_ipcw_L, il4_t3_adj_ipcw_L, il5_t3_adj_ipcw_L, il6_t3_adj_ipcw_L, tnf_t3_adj_ipcw_L, igf_t2_unadj_ipcw_L, igf_t3_unadj_ipcw_L, crp_t2_unadj_ipcw_L, agp_t2_unadj_ipcw_L, gmc_t2_unadj_ipcw_L, ifn_t2_unadj_ipcw_L, il10_t2_unadj_ipcw_L, il12_t2_unadj_ipcw_L, il13_t2_unadj_ipcw_L, il17_t2_unadj_ipcw_L, il1_t2_unadj_ipcw_L, il2_t2_unadj_ipcw_L, il21_t2_unadj_ipcw_L, il4_t2_unadj_ipcw_L, il5_t2_unadj_ipcw_L, il6_t2_unadj_ipcw_L, tnf_t2_unadj_ipcw_L, gmc_t3_unadj_ipcw_L, ifn_t3_unadj_ipcw_L, il10_t3_unadj_ipcw_L, il12_t3_unadj_ipcw_L, il13_t3_unadj_ipcw_L, il17_t3_unadj_ipcw_L, il1_t3_unadj_ipcw_L, il2_t3_unadj_ipcw_L, il21_t3_unadj_ipcw_L, il4_t3_unadj_ipcw_L, il5_t3_unadj_ipcw_L, il6_t3_unadj_ipcw_L, tnf_t3_unadj_ipcw_L, file=here("audrie results/immune_ipcw.RData"))
