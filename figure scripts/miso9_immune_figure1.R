...
d <- rbind(
  ...
  data.frame(readjustfunc(ifn_t2_N_tr), name="Interferon-ç (pg/ml)", age=14),
  data.frame(readjustfunc(ifn_t3_N_tr), name="Interferon-ç (pg/ml)", age=28),
  ...
  data.frame(readjustfunc(il1_t2_N_tr), name="Interleukin-1â (pg/ml)", age=14),
  data.frame(readjustfunc(il1_t3_N_tr), name="Interleukin-1â (pg/ml)", age=28),
  ...
  data.frame(readjustfunc(tnf_t2_N_tr), name="Tumor necrosis factor-á (pg/ml)", age=14),
  data.frame(readjustfunc(tnf_t3_N_tr), name="Tumor necrosis factor-á (pg/ml)", age=28),
  data.frame(readjustfunc(igf_t2_N_tr), name="Insulin-like growth factor-1 (íg/ml)", age=14),
  data.frame(readjustfunc(igf_t3_N_tr), name="Insulin-like growth factor-1 (íg/ml)", age=28),
...
tnf<-immune_plot_fun_wlabel(d, "Tumor necrosis factor-á (pg/ml)")
igf<-immune_plot_fun_wlabel(d, "Insulin-like growth factor-1 (íg/ml)")
