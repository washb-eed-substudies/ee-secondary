...
d <- rbind(
  ...
  data.frame(readjustfunc(t2_ratio_tnf_il10_N_tr), name="Tumor necrosis factor-á/Interleukin-10", age=14),
  data.frame(readjustfunc(t3_ratio_tnf_il10_N_tr), name="Tumor necrosis factor-á/Interleukin-10", age=28),
  ...
  data.frame(readjustfunc(t2_ratio_ifn_il10_N_tr), name="Interferon-ç/Interleukin-10", age=14),
  data.frame(readjustfunc(t3_ratio_ifn_il10_N_tr), name="Interferon-ç/Interleukin-10", age=28),
  ...
  data.frame(readjustfunc(t2_ratio_ifn_il4_N_tr), name="Interferon-ç/Interleukin-4", age=14),
  data.frame(readjustfunc(t3_ratio_ifn_il4_N_tr), name="Interferon-ç/Interleukin-4", age=28),
  ...
  data.frame(readjustfunc(t2_ratio_ifn_il5_N_tr), name="Interferon-ç/Interleukin-5", age=14),
  data.frame(readjustfunc(t3_ratio_ifn_il5_N_tr), name="Interferon-ç/Interleukin-5", age=28),
  ...
  data.frame(readjustfunc(t2_ratio_ifn_il13_N_tr), name="Interferon-ç/Interleukin-13", age=14),
  data.frame(readjustfunc(t3_ratio_ifn_il13_N_tr), name="Interferon-ç/Interleukin-13", age=28),
  ...
  data.frame(readjustfunc(t2_ratio_ifn_il17_N_tr), name="Interferon-ç/Interleukin-17", age=14),
  data.frame(readjustfunc(t3_ratio_ifn_il17_N_tr), name="Interferon-ç/Interleukin-17", age=28),
  ...
  data.frame(readjustfunc(t2_ratio_ifn_il21_N_tr), name="Interferon-ç/Interleukin-21", age=14),
  data.frame(readjustfunc(t3_ratio_ifn_il21_N_tr), name="Interferon-ç/Interleukin-21", age=28),
...
ggsave(p, file = here("figures/miso9-figure2-immune.png"), height=15, width=12)
