...
#Save results
saveRDS(H1_adj_res, here("telo-development/results/adjusted/H1_adj_res.RDS"))
...
#Save results
saveRDS(H2_adj_res, here("telo-development/results/adjusted/H2_adj_res.RDS"))
...
#Save results
saveRDS(H3_adj_res, here("telo-development/results/adjusted/H3_adj_res.RDS"))
...
#Save results
saveRDS(H4_adj_res, here("telo-development/results/adjusted/H4_adj_res.RDS"))
